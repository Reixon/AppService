...
public class BookingServiceActivity extends AppCompatActivity {
    ...
    private int sortDayOfWeek(int dayOfWeek){
    ...
    private void initialDataSchedule(){
        showProgress(true);
        dayOfWeek = sortDayOfWeek(calendar.get(Calendar.DAY_OF_WEEK));
    ...
    private void loadSchedule(){
        final int dayOfWeek = sortDayOfWeek(calendar.get(Calendar.DAY_OF_WEEK));
        String [] days = getResources().getStringArray(R.array.array_days_week);
